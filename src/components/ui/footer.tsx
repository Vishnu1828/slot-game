...
const BAR_H = 52; // footer bar height (px)
const PAD_X = 14; // horizontal inner padding
const ICON = 48; // icon button size
const LEFT_GAP = 18; // gap between Balance and Total Bet
